...
function Dispatche() {
  ...
  const [agences, setAgences] = useState([
    { id: 1, nom: "Agence Principale" },
    { id: 2, nom: "Agence Secondaire" },
  ])
  const [dispatches, setDispatches] = useState([
    {
      ...
      date: "2023-05-15",
      consommations: [
        { agenceId: 1, quantite: 50 },
        { agenceId: 2, quantite: 30 },
      ],
    },
    {
      id: 2,
      ...
      date: "2023-05-10",
      consommations: [
        { agenceId: 1, quantite: 20 },
        { agenceId: 2, quantite: 15 },
      ],
    },
  ])
  ...
  const [agencesWU, setAgencesWU] = useState([
    { id: 1, nom: "WU Principale" },
    { id: 2, nom: "WU Secondaire" },
  ])
  const [westernUnions, setWesternUnions] = useState([
    {
      id: 1,
      designation: "Formulaire WU",
      quantite: 300,
      date: "2023-05-15",
      consommations: [
        { agenceId: 1, quantite: 100 },
        { agenceId: 2, quantite: 50 },
      ],
    },
    {
      id: 2,
      designation: "Tampon WU",
      quantite: 50,
      date: "2023-05-10",
      consommations: [
        { agenceId: 1, quantite: 10 },
        { agenceId: 2, quantite: 5 },
      ],
    },
  ])
  ...
  const [agencesDir, setAgencesDir] = useState([
    ...
    { id: 2, nom: "Direction Régionale" },
  ])
  const [directions, setDirections] = useState([
    {
      id: 1,
      designation: "Rapport Annuel",
      quantite: 50,
      date: "2023-05-15",
      consommations: [
        { agenceId: 1, quantite: 20 },
        { agenceId: 2, quantite: 10 },
      ],
    },
    {
      id: 2,
      designation: "Dossier Administratif",
      quantite: 100,
      date: "2023-05-10",
      consommations: [
        { agenceId: 1, quantite: 30 },
        { agenceId: 2, quantite: 20 },
      ],
    },
  ])
  ...
  const supprimerWesternUnion = (id) => {
    ...
    boutonConfirmer.addEventListener("click", () => {
      ...
      setWesternUnions(westernUnions.filter((wu) => wu.id !== id))
